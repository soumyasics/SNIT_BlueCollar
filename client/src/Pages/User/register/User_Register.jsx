...
function User_Register() {
  return (
    ...
    <h1 className="user-register-heading text-center m-5">Sign Up</h1>
            ...
            <div className="mb-3">
              ...
              {/* <div className="d-flex align-items-center justify-content-between mb-4">
                <div className="form-check">
                  <input
                    ...
                    id="flexCheckChecked" />
                  <label
                    className="form-check-label user-register-label my-2"
              ...
              <div className="d-flex align-items-center justify-content-center">
                <p className="fs-5 mb-3 fw-bold ">
                  <a
                    className="fw-bold ms-2 mb-3 text-decoration-none user-register-label"
                    href=""
                  >
