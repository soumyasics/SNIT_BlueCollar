  ...
  return (
	...
	<article class="">
		<header class="addcomplait-modal-container-header">
			...
			<button class="addcomplait-icon-button" onClick={close}>
        ...
        <form>
          <div class="mb-3">
            ...
            <input type="text" class="addcomplait-input form-control" placeholder='Enter Suspect Name' id="recipient-name"/>
          </div>
          <div class="mb-3">
            <label for="message-text" class="col-form-label">Subject</label>
            <textarea class="addcomplait-textarea form-control" style={{height:'100px'}} placeholder='Add your Complaint' id="message-text"></textarea>
          </div>
        </form>
		</section>
